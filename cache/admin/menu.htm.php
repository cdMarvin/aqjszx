<?php /* Smarty version 2.6.26, created on 2017-07-21 10:10:23
...
<?php if ($this->_tpl_vars['unum']['system']): ?><span class="unum"><span><?php echo $this->_tpl_vars['unum']['system']; ?>
 ...
 <ul>
  ...
  <li<?php if ($this->_tpl_vars['cur'] == 'newshow'): ?> class="cur"<?php endif; ?>><a href="newshow.php"><i class="show"></i><em><?php echo $this->_tpl_vars['lang']['newshow']; ?>
</em></a></li>
  <li<?php if ($this->_tpl_vars['cur'] == 'friendlink'): ?> class="cur"<?php endif; ?>><a href="friendlink.php"><i class="show"></i><em><?php echo $this->_tpl_vars['lang']['friendlink']; ?>
</em></a></li>
...
<?php if ($this->_tpl_vars['menu']['name'] == 'plugin'): ?><?php if ($this->_tpl_vars['unum']['plugin']): ?><span class="unum"><span><?php echo $this->_tpl_vars['unum']['plugin']; ?>
 ...
 <ul class="bot">
  ...
  <li<?php if ($this->_tpl_vars['cur'] == 'mobile'): ?> class="cur"<?php endif; ?>><a href=""><i class="mobile"></i><em><?php echo $this->_tpl_vars['lang']['mobile']; ?>
定制开发</em></a></li>
  
  <?php if ($this->_tpl_vars['cur'] == 'theme'): ?><span class="unum"><span><?php echo $this->_tpl_vars['unum']['theme']; ?>
</span></span><?php endif; ?></em></a></li------->
