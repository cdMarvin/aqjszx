<?php /* Smarty version 2.6.26, created on 2017-08-15 10:09:26
         compiled from newshow.htm */ ?>
...
unset($_smarty_tpl_vars);
 ?>
   <div class="mainBox imgModule">
    ...
    <tr>
       <th><?php echo $this->_tpl_vars['lang']['newshow_add']; ?>
</th>
       <th><?php echo $this->_tpl_vars['lang']['newshow_list']; ?>
</th>
     </tr>
     <tr>
      <td width="350" valign="top">
       <form action="newshow.php?rec=<?php if ($this->_tpl_vars['show']): ?>update<?php else: ?>insert<?php endif; ?>"<?php if ($this->_tpl_vars['show']): ?> class="formEdit"<?php endif; ?> method="post" enctype="multipart/form-data">
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableOnebor">
         <tr>
          <td><b><?php echo $this->_tpl_vars['lang']['newshow_name']; ?>
</b>
...
" size="20" class="inpMain" />
         ...
         <tr>
          <td><b><?php echo $this->_tpl_vars['lang']['newshow_img']; ?>
</b>
...
" target="_blank"><img src="images/icon_yes.png"></a><?php else: ?><?php endif; ?>
         ...
         <tr>
          <td><b><?php echo $this->_tpl_vars['lang']['newshow_link']; ?>
</b>
...
" />
      ...
      <td valign="top">
       <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableOnebor">
        <tr>
         <td width="100"><?php echo $this->_tpl_vars['lang']['newshow_name']; ?>
</td>
         <td></td>
...
" width="100" /></a></td>
         ...
         <td align="center"><a href="newshow.php?rec=edit&id=<?php echo $this->_tpl_vars['show_list']['id']; ?>
"><?php echo $this->_tpl_vars['lang']['edit']; ?>
</a> | <a href="newshow.php?rec=del&id=<?php echo $this->_tpl_vars['show_list']['id']; ?>
